...
namespace luna
{
    ...
    public:
        ...
        void fill(luna::Color color) const;
        ...
        void drawPixel(int x, int y, luna::Color color) const;
        /// @brief Draws a solid grid
        /// @param cell_width cell's width
        /// @param cell_height cell's height
        /// @param color a color of the grid
        void drawSolidGrid(int cell_width, int cell_height, luna::Color color) const;
        /// @brief Draws a dotted grid with cell sizes provided
        /// @param cell_width cell's width
        /// @param cell_height cell's height
        /// @param color a color of the grid
        void drawDottedGrid(int cell_width, int cell_height, luna::Color color) const;
        ...
        void drawRect(int x_pos, int y_pos, int width, int height, luna::Color color) const;
        /// @brief Draws a line using DDA algorithm
        void drawLineDDA(int x0, int y0, int x1, int y1, luna::Color color) const;
        /// @brief Draws a line using Bresenham's algorithm
        void drawLineBresenham(int x0, int y0, int x1, int y1, luna::Color color) const;
        /// @brief Draws a trangle
        void drawEmptyTriangle(const luna::Triangle &triangle, luna::Color color) const;
    };
}
